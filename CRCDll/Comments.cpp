...
// 	m_BL_CheckMode.SetDropDownData(_T("CRC_4_ITU   X4+X+1;\
// 									CRC_5_ECP   X4+X3+1;\
// 									CRC_5_ITU   X5+X4+X2+1;\
// 									CRC_5_USB   X5+X2+1;\
// 									CRC_6_ITU   X6+X+1;\
// 									CRC_7_MMC   X7+X3+1;\
// 									CRC_8   X8+X2+X+1;\
// 									CRC_8_ITU   X8+X2+X+1;\
// 									CRC_8_ROHC   X8+X2+X+1;\
// 									CRC_8_MAXIM   X8+X5+X4+1;\
// 									CRC_16_IBM   X16+X15+X2+1;\
// 									CRC_16_MAXIM   X16+X15+X2+1;\
// 									CRC_16_USB   X16+X15+X2+1;\
// 									CRC_16_MODBUS   X16+X15+X2+1;\
// 									CRC_16_CCITT   X16+X12+X5+1;\
// 									CRC_16_CCITT_FALSE   X16+X12+X5+1;\
// 									CRC_16_X25   X16+X12+X5+1;\
// 									CRC_16_XMODEM   X16+X12+X5+1;\
// 									CRC_16_DNP   X16+X13+X12+X11+X10+X8+X6+X5+X2+1;\
// 									CRC_32   X32+X26+X23+X22+X16+X12+X11+X10+X8+X7+X5+X4+X2+X+1;\
// 									CRC_32_MPEG_2   X32+X26+X23+X22+X16+X12+X11+X10+X8+X7+X5+X4+X2+X+1;"));
